...
const baseHomeMessages: Record<"es" | "en" | "pr", HomeMessages> = {
  es: {
    ...
    hero: {
      badge: "Finanzas compartidas sin enredos",
      title: "Controla tus gastos, grupos y metas desde una sola app",
      words: ["dividir", "compartir", "administrar"],
      titlePrefix: "La forma de",
      titleSuffix: "tus gastos en grupo",
      description:
        "Divide cuentas, registra gastos personales, programa recordatorios y sigue metas de ahorro con una experiencia clara para iOS y Android.",
  ...
  en: {
    ...
    hero: {
      badge: "Shared finances without the mess",
      title: "Control expenses, groups, and goals from one app",
      words: ["split", "share", "manage"],
      titlePrefix: "The way to",
      titleSuffix: "manage your group expenses",
      description:
        "Split bills, track personal spending, schedule reminders, and follow savings goals with a clear experience for iOS and Android.",
  ...
  pr: {
    ...
    hero: {
      badge: "Finanças compartilhadas sem confusão",
      title: "Controle despesas, grupos e metas em um só app",
      words: ["dividir", "compartilhar", "organizar"],
      titlePrefix: "A forma de",
      titleSuffix: "organizar suas despesas em grupo",
      description:
        "Divida contas, registre despesas pessoais, programe lembretes e acompanhe metas de economia com uma experiência clara para iOS e Android.",
