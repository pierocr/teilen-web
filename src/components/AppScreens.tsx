...
export function AppScreens({
  ...
  return (
    <section id="screens" className="mx-auto max-w-6xl px-5 py-10 sm:py-20 fhd:py-24 fhd:px-8">
...
function PhoneScreen({ src, alt }: { src: string; alt: string }) {
  return (
    <div className="relative flex items-center justify-center rounded-2xl border border-slate-100 bg-white p-2.5 shadow-[0_14px_36px_rgba(15,23,42,0.1)] sm:rounded-3xl sm:p-4 sm:shadow-[0_20px_55px_rgba(15,23,42,0.1)]">
